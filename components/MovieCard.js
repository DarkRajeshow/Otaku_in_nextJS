...
export default function MovieCard({ gradientStyleForMobile, index, title, openOverview, imageIndex, rating, offSetPage, duration }) {
    return (
        <motion.div
            className={`w-full h-[80vh] ${imageIndex === index ? "block" : "hidden"} overflow-hidden rounded-r-[50px] rounded-l-[10px]`}
        ...
        >
            <div className='gradientDiv w-[60%] relative top-[35%] left-10'>
                ...
                <p className='text-sm min-[400px]:text-md lg:text-lg font-bold flex items-center mb-4'><FaClock className='mr-1 text-primaryDark'/> {duration} min.</p>
                ...
                <button className='text-[12px] min-[400px]:text-sm md:text-base font-bold p-2 md:px-4 md:py-3 bg-light text-dark rounded-lg my-4 flex items-center'
