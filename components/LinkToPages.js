...
export default function LinkToPages() {
    return (
        <div className='absolute py-32 w-full flex flex-col items-center justify-center bg-themeBgDark bg-cover bg-no-repeat bg-center -z-20'>
            ...
            <div className='grid lg:grid-cols-2 w-[80%] gap-10 my-20'>
                <div className="grid1 px-10 py-8 rounded-[20px] text-left bg-black relative border-2 border-light">
                    <div className="col-span-4 p-5 top-0 left-0 absolute -z-10 w-[103%] sm:w-[102%] md:w-[101.3%] lg:w-[103%] h-[103%] border-2 border-dark rounded-[30px] bg-light" />
                    ...
                    <Link href={"/step1"}>
                        <button className='border-2 border-light flex items-center bg-light text-dark font-bold p-3 rounded-lg text-sm sm:text-base md:text-md lg:text-lg my-5 hover:text-light hover:bg-dark transition-[300ms]'><FaIndent className='mr-2 text-primary' /> Discover Anime </button>
                    </Link>
                </div>
                <div className="grid1 px-10 py-8 rounded-[20px] text-left bg-black border-2 border-light relative">
                    <div className="col-span-4 p-5 bg-light top-0 left-0 absolute w-[103%] sm:w-[102%] md:w-[101.3%] lg:w-[103%] h-[103%] border-2 border-dark rounded-[30px] -z-10" />
                    ...
                    <Link href={"/search"} >
                        <button className='flex items-center bg-light text-dark font-bold p-3 rounded-lg text-sm sm:text-base md:text-md lg:text-lg my-5 border-2 border-light hover:text-light hover:bg-dark transition-[300ms]'>
